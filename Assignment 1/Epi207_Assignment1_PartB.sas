...
PROC FORMAT LIBRARY = epi207;
	...
	value Q		1 = 'Q1'
				...
				3 = 'Q3'
				4 = 'Q4';
	value Underweightgr low-<18.5 = '1-Yes'
					  18.5-high = '0-No';
	value Agegr 20-<30 = '1'
				30-<40 = '2'
				40-<50 = '3'
...
DATA epi207.outdata2;
	...
	Underweight = put(bexam_BMI, Underweightgr.);
	Agegroup = put(Age, Agegr.);
	drop BMIgr;
RUN;
...
Label	ID 		= "ID"
		...
		Underweight			= "Underweight (BMI <18.5 kg/m^2)"
